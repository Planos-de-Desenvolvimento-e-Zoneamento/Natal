...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:31985',
            //extent: [240318.403091, 9340858.839801, 262457.498802, 9365811.948079],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([254588.338582, 9360993.038630, 256190.899440, 9361877.137379], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Zoneamento do PDZ do Porto de Natal</h2>';
        return titleElement;
    })(),
